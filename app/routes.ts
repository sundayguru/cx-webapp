...
export default [
  ...
  layout('./routes/layouts/ProtectedLayout.tsx', [
    ...
    route('courses/:id/community', 'routes/courses/$id.community.tsx'),
    ...
    route(
      'api/courses/:id/tag-module-units-heuristic',
      'routes/api/courses/tag-module-units-heuristic.tsx',
    ),
    route(
    ...
    route('api/courses/:id/delete', 'routes/api/courses/$id.delete.tsx'),
